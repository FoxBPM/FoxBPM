...
public class CalendarPartResource extends AbstractRestResource{
	...
	public DataResult getTasks(){
		...
		result.setData(workCalendarService.getCalendarPart());
		result.setPageIndex(pageIndex);
		result.setPageSize(pageSize);
		result.setRecordsTotal(workCalendarService.getCalendarPart().size());
		result.setRecordsFiltered(workCalendarService.getCalendarPart().size());
		return result;
	}
}
