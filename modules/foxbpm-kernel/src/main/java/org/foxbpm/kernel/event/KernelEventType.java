...
public class KernelEventType {

	public static final String EVENTTYPE_SEQUENCEFLOW_TAKE = "sequenceflow-take";
	...
	public static final String EVENTTYPE_PROCESS_START_INITIAL = "process-start-initial";
	...
	public static final String EVENTTYPE_NODE_EXECUTE = "node-execute";
