 ...
 * @author kenshin
 */
package org.foxbpm.engine.impl.log;
...
public class OperationLog {
     ...
     * ロギングラッパーのクラス名
     */
    private static final String FQCN = OperationLog.class.getName();
    ...
    protected OperationLog(Class cls) {
        logger = org.apache.log4j.Logger.getLogger("operation." + cls.getName());
    }
