...
public interface UserDefinition {
	...
	/**
	 * 根据查询条件获取用户列表 选择转发人，查询等选人界面时使用，不用系统提供界面时可不实现
	 */
	List<UserEntity> findUsers(String idLike, String nameLike);
	
	/**
	 * 根据查询条件获取用户列表（分页） 选择转发人，查询等选人界面时使用，不用系统提供界面时可不实现
	 */
	List<UserEntity> findUsers(String idLike, String nameLike, int firstResult, int maxResults);
	
	/**
	 * 根据查询条件获取用户数量 选择转发人，查询等选人界面时使用，不用系统提供界面时可不实现
	 */
