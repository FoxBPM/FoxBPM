...
public class SvgIntermediateEventComponent implements ISvgComponent {

	private static String comPath = "/svgcomponent/IntermediateEvent.xml";
	
	public String createComponent(SvgBaseTo svgTo) {
		String result = null;
		try {
			SvgIntermediateEventTo stevent = (SvgIntermediateEventTo)svgTo;
