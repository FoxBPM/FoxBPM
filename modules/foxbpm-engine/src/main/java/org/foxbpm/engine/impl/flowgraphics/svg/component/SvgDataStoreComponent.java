...
public class SvgDataStoreComponent implements ISvgComponent {

	private static String comPath = "/svgcomponent/DataStore.xml";
	
	
	public String createComponent(SvgBaseTo svgTo) {
		String result = null;
		try {
			SvgDataStoreTo stevent = (SvgDataStoreTo)svgTo;
