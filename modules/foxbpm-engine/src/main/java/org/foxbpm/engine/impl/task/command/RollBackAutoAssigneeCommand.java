 ...
 * 
 */
public class RollBackAutoAssigneeCommand extends AbstractCustomExpandTaskCommand {
	...
	public RollBackAutoAssigneeCommand(ExpandTaskCommand expandTaskCommand) {
