...
public class IoUtil {
  ...
  public static byte[] readInputStream(InputStream inputStream, String inputStreamName) {
    ...
    try {
      ...
      throw new FixFlowException("couldn't read input stream "+inputStreamName, e);
    }
  ...
  public static String readFileAsString(String filePath) {
    ...
    try {
      ...
      throw new FixFlowException("Couldn't read file " + filePath + ": " + e.getMessage());
    } finally {
  ...
  public static File getFile(String filePath) {
    ...
    try {
      ...
      throw new FixFlowException("Couldn't get file " + filePath + ": " + e.getMessage());
    }
  }
