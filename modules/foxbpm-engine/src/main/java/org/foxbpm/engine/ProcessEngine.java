...
public interface ProcessEngine {
	...
	/**
	 * 获取历史数据服务 (主要作用是用于管理流程实例、任务实例等历史数据的操作)
	 * 
	 * @return 历史数据服务
	 */
	...
	/**
	 * 关闭流程引擎 (关注销引擎对象、关闭定时服务、数据库连接、脚本语言)
	 */
	void closeEngine();
