 ...
 *
 */
public class TransferAndCreateTaskCmd extends AbstractExpandTaskCmd<TransferTaskCommand, Void> {
	...
	public TransferAndCreateTaskCmd(TransferTaskCommand transferTaskCommand) {
