...
public class SvgEndErrorEventComponent implements ISvgComponent {

	private static String comPath = "/svgcomponent/EndErrorEvent.xml";
	
	public String createComponent(SvgBaseTo svgTo) {
		String result = null;
		try {
			SvgEndErrorEventTo stevent = (SvgEndErrorEventTo)svgTo;
