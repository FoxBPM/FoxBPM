...
import org.foxbpm.engine.impl.task.command.UpdateCompletionRateCommand;
 ...
 *
 */
public class UpdateCompletionRateCmd extends AbstractExpandTaskCmd<UpdateCompletionRateCommand, Void> {
	...
	public UpdateCompletionRateCmd(UpdateCompletionRateCommand abstractCustomExpandTaskCommand) {
		super(abstractCustomExpandTaskCommand);
		this.completionRate=abstractCustomExpandTaskCommand.getCompletionRate();
	}
