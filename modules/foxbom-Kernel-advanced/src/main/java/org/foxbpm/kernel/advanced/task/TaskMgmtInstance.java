...
import org.foxbpm.kernel.advanced.entity.TaskEntity;
...
public class TaskMgmtInstance {
	...
	public TaskEntity createTaskInstanceEntity(TaskDefinition taskDefinition, ExecutionContext executionContext) {
