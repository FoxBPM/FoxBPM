...
function(a) {
    a.fn.SuperBox = function() {
        ...
        c = a('<img class="superbox-current-img" ><div id="imgInfoBox" class="superbox-imageinfo inline-block"> <h1>Image Title</h1><span><p><em>http://imagelink.com/thisimage.jpg</em></p><p class="superbox-img-description">Image description</p><p><a href="javascript:void(0);" class="btn btn-primary btn-sm" id="start">Start</a> <a href="javascript:void(0);" class="btn btn-danger btn-sm" id="cancel">Cancel</a></p></span> </div>'),
        ...
        return this.each(function() {
            ...
            var start =  function(){
				...
				if(!href_showDetailInfor){
					...
					href_showDetailInfor.href = "#ajaxpage/form.html?processDefinitionKey="+key;
