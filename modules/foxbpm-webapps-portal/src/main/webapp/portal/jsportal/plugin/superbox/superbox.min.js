...
function(a) {
    a.fn.SuperBox = function() {
        ...
        c = a('<img src="" class="superbox-current-img" style="height:400px;width:600px;"><div id="imgInfoBox" class="superbox-imageinfo inline-block"> <h1>Image Title</h1><span><p><em>http://imagelink.com/thisimage.jpg</em></p><p class="superbox-img-description">Image description</p><p><a href="javascript:void(0);" class="btn btn-primary btn-sm" id="start">Start</a> <a href="javascript:void(0);" class="btn btn-danger btn-sm" id="cancel">Cancel</a></p></span> </div>'),
        ...
        return this.each(function() {
            ...
            var start =  function(){
				...
				var url = obj.attr("formUrl");
				var href_showDetailInfor = document.getElementById("href_showDetailInfor");
				if(!href_showDetailInfor){
					href_showDetailInfor =  document.createElement("a");
					href_showDetailInfor.id = "href_showDetailInfor";
					href_showDetailInfor.style.display = "none";
					href_showDetailInfor.href = "#ajaxpage/showTaskDetailInfor.html";
					document.body.appendChild(href_showDetailInfor);
					href_showDetailInfor.click();
					document.body.removeChild(href_showDetailInfor);
				}
            };
