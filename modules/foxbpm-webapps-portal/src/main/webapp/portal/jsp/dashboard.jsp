			...
			var pagefunction = function() {
			    ...
			    $('#calendar').fullCalendar({
					...
					eventMouseover:function(event, jsEvent, view ) {
						...
						$("#eventInfoTipCreateTime").html("创建:  "+event.start.format());
						$("#eventInfoTipTitle").html("标题:  "+event.title);
						$("#eventInfoTip").css("display", "block");  
		              	$("#eventInfoTip2").css("top",jsEvent.clientY-20);  
		               	$("#eventInfoTip2").css("left",jsEvent.clientX-200);  
						$("#eventInfoTip").show(); 
					},
