...
import org.foxbpm.social.impl.persistence.SocialManager;
 ...
 *
 */
public class AddSocialUserCmd implements Command<Void>{
	
	private SocialUser socialUser;
	
	public AddSocialUserCmd(SocialUser socialUser){
