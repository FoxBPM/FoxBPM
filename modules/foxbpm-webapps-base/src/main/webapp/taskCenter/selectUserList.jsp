...
<body>
	<form id="subForm" method="post" action="selectUserList.action">
				...
				<table width="100%">
					<tr>
						...
						<td style="width: 180px"><input type="text" id="text_0"
							name="id" class="fix-input" style="width: 160px;"
							value="${result.queryInfo}" /></td>
						<td class="title-r">用户姓名：</td>
						<td style="width: 180px"><input type="text" id="text_0"
							name="name" class="fix-input" style="width: 160px;"
							value="${result.queryInfo}" /></td>
