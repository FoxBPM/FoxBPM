...
<body>
	<div class="main-panel">
		...
		<div class="center-panel">
			<form id="subForm" method="post" action="queryToDoTask.action">
				<!-- 左 -->
				<div class="left">
							...
							<c:forEach items="${result.agentToUsers}" var="agentToUsers"
								...
								<div class="left-nav" id="agent_${agentToUsers.userid}">
									<a name="agentToUsers" userId="${agentToUsers.userid}" href="#"><img
										...
										width="30" alt="头像"
										onerror="miniImgNotFound('<%=request.getContextPath()%>',this);" />${agentToUsers.username}</a>
								</div>
							</c:forEach>
						</c:if>
					</div>
					<div class="message" style="display: none">
						...
						<div class="message-content">
							...
							<div class="msg">
								<img src="images/temp/user01.jpg"
									onerror="miniImgNotFound('<%=request.getContextPath()%>',this);" />曹操：煮酒论英雄！谁一起吃饭啊
								<div class="time">一小时前</div>
							</div>
							<div class="msg">
								<img src="images/temp/user01.jpg"
				...
				<div class="right">
					...
					<input type="hidden" id="agentUserId" name="agentUserId"
						...
						value="<c:out value="${result.agentType}"/>">
					<div class="search">
						<table>
							<tr>
