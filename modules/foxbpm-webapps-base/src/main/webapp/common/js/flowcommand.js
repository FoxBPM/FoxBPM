function regFlowCommand(formId, processInstanceId, processDefinitionKey,processDefinitionId, taskId) {
	...
	var cprocessDefinitionId = '<input type="hidden" id="processDefinitionId" name="processDefinitionId" value="'+ processDefinitionId + '"/>';
	...
	$("#" + formId).append(cprocessDefinitionId);
	$("#" + formId).append(ctaskId);

	$("div[commandType],button[commandType]")
			.click(
					function() {
						...
						if (type == "processStatus") {
							...
							var pdi = processDefinitionId;
							window
									.open("queryTaskDetailInfor.action?processInstanceId="
											+ pii
