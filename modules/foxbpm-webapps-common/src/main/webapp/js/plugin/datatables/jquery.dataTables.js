...
(/** @lends <global> */function( $ ) {
	...
	function showMsg(title,msg){  
		if(msg.indexOf('Ajax error')!=-1){msg="向服务器请求出现问题，请联系系统管理员!";
		} else if(msg.indexOf('Invalid JSON response')!=-1 || msg.indexOf('Requested unknown parameter')!=-1){msg="向服务器发送请求时，服务器响应的数据有问题，请联系系统管理员!";
		} else {msg="数据加载出现问题!";}
		$.bigBox({
			title : title,
			content : msg,
